...
import 'package:meatzy/Screen/Notification/notification_screen.dart';
                ...
                builder: (context, snapshot) {
                  ...
                  if (snapshot.hasData) {
                    ...
                    List<SellerNotification>? notification =
                        meatSellerModel!.notifications;
                    List<Product>? sellerproducts = meatSellerModel.products;
                    return notificationWidget(
            ...
            StreamBuilder<List<Product>>(
              ...
              builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
                ...
                if (snapshot.hasData) {
                  ...
                  List<Product>? allProducts = snapshot.data.reversed.toList();
                  print("//////////////");
                  print('allProducts is ${allProducts}');
                  //   print("//////////////");
                  //   print("//////////////");
                  //  // print("the seller data is ${allProducts[0].sellerName}");
                  //   print("//////////////");
